...
namespace BlazorBlog.Pages
{
    public partial class MainPage : ComponentBase
    {
        ...
        protected override void OnInitialized()
        {
            ...
            AboutBlog = new AboutEntity { Title = "About Blog", Content = "This is an experiment. I would like to learn Blazor, html, css and other web stuff. Since the best way (for me) to learn is to use. I want to make a blog about creating a blog in Blazor." };
            base.OnInitialized();
        }
